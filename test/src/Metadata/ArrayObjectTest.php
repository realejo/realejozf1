...
use RealejoZf1\Metadata\ArrayObject;
use RealejoZf1\Metadata\MetadataArrayObject;
...
class ArrayObjectTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testMetadata()
    {
        ...
        $this->assertInstanceOf('\RealejoZf1\Stdlib\ArrayObject', $object);

        $metadata = new MetadataArrayObject(array('one'=>'first'));

        $this->assertInstanceOf('\RealejoZf1\Metadata\ArrayObject', $object->setMetadata($metadata));
        $this->assertInstanceOf('\RealejoZf1\Metadata\MetadataArrayObject', $object->getMetadata());
    ...
    public function testAddMetadata()
    {
        ...
        $this->assertInstanceOf('\RealejoZf1\Metadata\ArrayObject', $object->addMetadata($metadata));
        $this->assertInstanceOf('\RealejoZf1\Metadata\MetadataArrayObject', $object->getMetadata());
