...
abstract class ServiceAbstract
{
    ...
    /**
     * @var \RealejoZf1\Mapper\MapperAbstract
     */
    protected $mapper;
    ...
    public function findAll($where = null, $order = null, $count = null, $offset = null)
    {
        ...
        if ($this->getUseCache() && $this->getCache()->test($cacheKey)) {
        ...
        if ($this->getUseCache()) {
            $this->getCache()->save($findAll, $cacheKey);
        }
    ...
    public function findOne($where = null, $order = null)
    {
        ...
        // Grava a consulta no cache
        if ($this->getUseCache()) {
            $this->getCache()->save($findOne, $cacheKey);
        }
    ...
    public function findAssoc($where = null, $order = null, $count = null, $offset = null)
    {
        ...
        // Grava a consulta no cache
        if ($this->getUseCache()) {
            $this->getCache()->save($findAssoc, $cacheKey);
        }
    ...
    public function findPaginated($where = null, $order = null, $count = null, $offset = null)
    {
        ...
        $cacheKey = 'findPaginated'.md5($select->assemble());
    ...
    /**
     * @param \RealejoZf1\Mapper\MapperAbstract|string $mapper
     */
    public function setMapper($mapper)
    {
        if (is_string($mapper)) {
            ...
            $this->mapper      = null;
        } elseif ($mapper instanceof \RealejoZf1\Mapper\MapperAbstract) {
            $this->mapper      = $mapper;
    ...
    public function getPaginatorOptions()
    {
        ...
        {
            $this->paginatorOptions = new \RealejoZf1\Options\PaginatorOptions();
        }
