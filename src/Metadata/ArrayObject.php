 ...
 *
 * Ele deveria extender RealejoZf1\Stdlib\ArrayObject mas como rescreve a maioria dos
 * metodos eu deixei numa classe a parte
 */
namespace RealejoZf1\Metadata;

use \RealejoZf1\Stdlib\ArrayObject as StdlibArrayObject;

class ArrayObject extends StdlibArrayObject
{
    /**
     * @var \RealejoZf1\Metadata\MetadataArrayObject
     */
    protected $metadata;

    /**
     * @return \RealejoZf1\Metadata\MetadataArrayObject
     */
